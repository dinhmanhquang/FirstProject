module Api
  class AdminsPasswordsController < Api::BaseController
    # jitera-anchor-dont-touch: before_action_filter

    before_action :doorkeeper_authorize!, only: ['create']

    before_action :current_admin_authenticate, only: ['create']
    ...
    def create
      if current_user.valid_password?(params[:old_password])
        ...
        render json: { error_message: I18n.t('devise.passwords.old_password_mismatch') }, status: :unprocessable_entity
      end
    end
